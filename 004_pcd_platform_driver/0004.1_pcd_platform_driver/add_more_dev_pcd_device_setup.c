...
struct platform_device platform_pcdev_3 = {
        ...
        .name = "pcdev-C1x",
        .id = 2, //in group of devices,it is used as index
...
struct platform_device platform_pcdev_4 = {
        ...
        .name = "pcdev-D1x",
        .id = 3, //in group of devices,it is used as index
...
{//initialize with add of pltfrm devices
	&platform_pcdev_1,
	&platform_pcdev_2,
	&platform_pcdev_3,
	&platform_pcdev_4
...
static int __init pcdev_platform_init(void)
{
	...
	platform_device_register(&platform_pcdev_2); no need to use 4 times for 4 devices,
       	use  below fn which need array of platfrm devices , so create array, above*/
